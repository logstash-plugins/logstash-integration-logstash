...
| <<plugins-{type}s-{plugin}-compression_enabled>> |<<boolean,boolean>> |No
...
[id="plugins-{type}s-{plugin}-compression_enabled"]
===== `compression_enabled`

* Value type is a <<boolean,boolean>>
* Default value is `true`

Enable or disable a compression when transferring the data.
